...
#### Considerations in this configuration:
- Only the management interface of the [node]({{< ref "docs/concepts/node" >}}) is used, requiring a minimum of 3 IP addresses to support both management/data traffic.
